!function (t, e) {
    ...
    function g(t) {
        if (null == t._isValid) {
            var e = D(t), n = r.call(e.parsedDateParts, function (t) {
                    return null != t
                }),
    ...
    function y(t, e) {
        var n, i, r;
        if (u(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), u(e._i) || (t._i = e._i), u(e._f) || (t._f = e._f), u(e._l) || (t._l = e._l), u(e._strict) || (t._strict = e._strict), u(e._tzm) || (t._tzm = e._tzm), u(e._isUTC) || (t._isUTC = e._isUTC), u(e._offset) || (t._offset = e._offset), u(e._pf) || (t._pf = D(e)), u(e._locale) || (t._locale = e._locale), 0 < o.length) for (n = 0; n < o.length; n++) u(r = e[i = o[n]]) || (t[i] = r);
        return t
    }
    ...
    function b(t) {
        y(this, t), this._d = new Date(null != t._d ? t._d.getTime() : NaN), this.isValid() || (this._d = new Date(NaN)), !1 === e && (e = !0, m.updateOffset(this), e = !1)
    }
    ...
    function T(t, e) {
        null != m.deprecationHandler && m.deprecationHandler(t, e), C[t] || (M(e), C[t] = !0)
    }
    ...
    function P(t, e) {
        var n, i = p({}, t);
        for (n in e) w(e, n) && (l(t[n]) && l(e[n]) ? (i[n] = {}, p(i[n], t[n]), p(i[n], e[n])) : null != e[n] ? i[n] = e[n] : delete i[n]);
    ...
    m.suppressDeprecationWarnings = !1, m.deprecationHandler = null, i = Object.keys ? Object.keys : function (t) {
        var e, n = [];
    ...
    function G(t, e) {
        return t.isValid() ? (e = U(e, t.localeData()), V[e] = V[e] || function (i) {
            var t, r, e, o = i.match(L);
            for (t = 0, r = o.length; t < r; t++) B[o[t]] ? o[t] = B[o[t]] : o[t] = (e = o[t]).match(/\[[\s\S]/) ? e.replace(/^\[|\]$/g, "") : e.replace(/\\/g, "");
            return function (t) {
                var e, n = "";
    ...
    function U(t, e) {
        ...
        for (A.lastIndex = 0; 0 <= n && A.test(t);) t = t.replace(A, i), A.lastIndex = 0, n -= 1;
        return t
    }

    var W = /\d/, j = /\d\d/, q = /\d{3}/, Z = /\d{4}/, $ = /[+-]?\d{6}/, Q = /\d\d?/, X = /\d\d\d\d?/,
        J = /\d\d\d\d\d\d?/, K = /\d{1,3}/, tt = /\d{1,4}/, et = /[+-]?\d{1,6}/, nt = /\d+/, it = /[+-]?\d+/,
        rt = /Z|[+-]\d\d:?\d\d/gi, ot = /Z|[+-]\d\d(?::?\d\d)?/gi,
        st = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i,
        at = {};

    function lt(t, n, i) {
        at[t] = R(n) ? n : function (t, e) {
            return t && i ? i : n
        }
    }
    ...
    var pt = 0, ft = 1, gt = 2, vt = 3, yt = 4, mt = 5, wt = 6, Dt = 7, bt = 8;
    ...
    }), N(0, ["YYYY", 4], 0, "year"), N(0, ["YYYYY", 5], 0, "year"), N(0, ["YYYYYY", 6, !0], 0, "year"), x("year", "y"), z("year", 1), lt("Y", it), lt("YY", Q, j), lt("YYYY", tt, Z), lt("YYYYY", et, $), lt("YYYYYY", et, $), ct(["YYYYY", "YYYYYY"], pt), ct("YYYY", function (t, e) {
    ...
    var Et, Mt = Ct("FullYear", !0);

    function Ct(e, n) {
        return function (t) {
            return null != t ? (Rt(this, e, t), m.updateOffset(this, n), this) : Tt(this, e)
        }
    }
    ...
    function Rt(t, e, n) {
        t.isValid() && !isNaN(n) && ("FullYear" === e && _t(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](n, t.month(), Pt(n, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](n))
    }

    function Pt(t, e) {
        if (isNaN(t) || isNaN(e)) return NaN;
        var n = (e % 12 + 12) % 12;
        return t += (e - n) / 12, 1 === n ? _t(t) ? 29 : 28 : 31 - n % 7 % 2
    }
    ...
    }), x("month", "M"), z("month", 8), lt("M", Q), lt("MM", Q, j), lt("MMM", function (t, e) {
    ...
    function Ot(t, e) {
        ...
        if ("string" == typeof e) if (/^\d+$/.test(e)) e = E(e); else if (!d(e = t.localeData().monthsParse(e))) return t;
        return n = Math.min(t.date(), Pt(t.year(), e)), t._d["set" + (t._isUTC ? "UTC" : "") + "Month"](e, n), t
    }

    function kt(t) {
        return null != t ? (Ot(this, t), m.updateOffset(this, !0), this) : Tt(this, "Month")
    }
    ...
    function Yt() {
        ...
        for (i.sort(t), r.sort(t), o.sort(t), e = 0; e < 12; e++) i[e] = ut(i[e]), r[e] = ut(r[e]);
    ...
    function Vt(t, e, n, i, r) {
        var o, s, a = 1 + 7 * (e - 1) + (7 + n - i) % 7 + At(t, i, r);
        return s = a <= 0 ? St(o = t - 1) + a : a > St(t) ? (o = t + 1, a - St(t)) : (o = t, a), {year: o, dayOfYear: s}
    }

    function Bt(t, e, n) {
        var i, r, o = At(t.year(), e, n), s = Math.floor((t.dayOfYear() - o - 1) / 7) + 1;
        return s < 1 ? i = s + Nt(r = t.year() - 1, e, n) : s > Nt(t.year(), e, n) ? (i = s - Nt(t.year(), e, n), r = t.year() + 1) : (r = t.year(), i = s), {
            week: i,
            year: r
        }
    }
    ...
    function Nt(t, e, n) {
        var i = At(t, e, n), r = At(t + 1, e, n);
        return (St(t) - i + r) / 7
    }

    N("w", ["ww", 2], "wo", "week"), N("W", ["WW", 2], "Wo", "isoWeek"), x("week", "w"), x("isoWeek", "W"), z("week", 5), z("isoWeek", 5), lt("w", Q), lt("ww", Q, j), lt("W", Q), lt("WW", Q, j), ht(["w", "ww", "W", "WW"], function (t, e, n, i) {
        e[i.substr(0, 1)] = E(t)
    ...
    }), N("e", 0, 0, "weekday"), N("E", 0, 0, "isoWeekday"), x("day", "d"), x("weekday", "e"), x("isoWeekday", "E"), z("day", 11), z("weekday", 11), z("isoWeekday", 11), lt("d", Q), lt("e", Q), lt("E", Q), lt("dd", function (t, e) {
    ...
    var Gt = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
        Ut = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Wt = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), jt = st, qt = st,
        Zt = st;
    ...
    function $t() {
        ...
        for (e = 0; e < 7; e++) n = f([2e3, 1]).day(e), i = this.weekdaysMin(n, ""), r = this.weekdaysShort(n, ""), o = this.weekdays(n, ""), s.push(i), a.push(r), l.push(o), u.push(i), u.push(r), u.push(o);
        for (s.sort(t), a.sort(t), l.sort(t), u.sort(t), e = 0; e < 7; e++) a[e] = ut(a[e]), l[e] = ut(l[e]), u[e] = ut(u[e]);
    ...
    N("H", ["HH", 2], 0, "hour"), N("h", ["hh", 2], 0, Qt), N("k", ["kk", 2], 0, function () {
    ...
    }), Xt("a", !0), Xt("A", !1), x("hour", "h"), z("hour", 13), lt("a", Jt), lt("A", Jt), lt("H", Q), lt("h", Q), lt("k", Q), lt("HH", Q, j), lt("hh", Q, j), lt("kk", Q, j), lt("hmm", X), lt("hmmss", J), lt("Hmm", X), lt("Hmmss", J), ct(["H", "HH"], vt), ct(["k", "kk"], function (t, e, n) {
        var i = E(t);
        e[vt] = 24 === i ? 0 : i
    }), ct(["a", "A"], function (t, e, n) {
        n._isPm = n._locale.isPM(t), n._meridiem = t
    }), ct(["h", "hh"], function (t, e, n) {
        e[vt] = E(t), D(n).bigHour = !0
    }), ct("hmm", function (t, e, n) {
        var i = t.length - 2;
        e[vt] = E(t.substr(0, i)), e[yt] = E(t.substr(i)), D(n).bigHour = !0
    }), ct("hmmss", function (t, e, n) {
        var i = t.length - 4, r = t.length - 2;
        e[vt] = E(t.substr(0, i)), e[yt] = E(t.substr(i, 2)), e[mt] = E(t.substr(r)), D(n).bigHour = !0
    }), ct("Hmm", function (t, e, n) {
        var i = t.length - 2;
        e[vt] = E(t.substr(0, i)), e[yt] = E(t.substr(i))
    }), ct("Hmmss", function (t, e, n) {
        var i = t.length - 4, r = t.length - 2;
        e[vt] = E(t.substr(0, i)), e[yt] = E(t.substr(i, 2)), e[mt] = E(t.substr(r))
    });
    var Kt, te = Ct("Hours", !0), ee = {
        calendar: {
            sameDay: "[Today at] LT",
    ...
    function se(t, e) {
        var n;
        return t && ((n = u(e) ? le(t) : ae(t, e)) ? Kt = n : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")), Kt._abbr
    }

    function ae(t, e) {
        if (null === e) return delete ne[t], null;
        var n, i = ee;
        if (e.abbr = t, null != ne[t]) T("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), i = ne[t]._config; else if (null != e.parentLocale) if (null != ne[e.parentLocale]) i = ne[e.parentLocale]._config; else {
        ...
        return ne[t] = new H(P(i, e)), ie[t] && ie[t].forEach(function (t) {
            ae(t.name, t.config)
        }), se(t), ne[t]
    }
    ...
    function ue(t) {
        var e, n = t._a;
        return n && -2 === D(t).overflow && (e = n[ft] < 0 || 11 < n[ft] ? ft : n[gt] < 1 || n[gt] > Pt(n[pt], n[ft]) ? gt : n[vt] < 0 || 24 < n[vt] || 24 === n[vt] && (0 !== n[yt] || 0 !== n[mt] || 0 !== n[wt]) ? vt : n[yt] < 0 || 59 < n[yt] ? yt : n[mt] < 0 || 59 < n[mt] ? mt : n[wt] < 0 || 999 < n[wt] ? wt : -1, D(t)._overflowDayOfYear && (e < pt || gt < e) && (e = gt), D(t)._overflowWeeks && -1 === e && (e = Dt), D(t)._overflowWeekday && -1 === e && (e = bt), D(t).overflow = e), t
    }
    ...
    function ce(t) {
        ...
        if (!t._d) {
            var a, l;
            for (a = t, l = new Date(m.now()), i = a._useUTC ? [l.getUTCFullYear(), l.getUTCMonth(), l.getUTCDate()] : [l.getFullYear(), l.getMonth(), l.getDate()], t._w && null == t._a[gt] && null == t._a[ft] && function (t) {
                var e, n, i, r, o, s, a, l;
                if (null != (e = t._w).GG || null != e.W || null != e.E) o = 1, s = 4, n = de(e.GG, t._a[pt], Bt(Me(), 1, 4).year), i = de(e.W, 1), ((r = de(e.E, 1)) < 1 || 7 < r) && (l = !0); else {
                    o = t._locale._week.dow, s = t._locale._week.doy;
                    var u = Bt(Me(), o, s);
                    n = de(e.gg, t._a[pt], u.year), i = de(e.w, u.week), null != e.d ? ((r = e.d) < 0 || 6 < r) && (l = !0) : null != e.e ? (r = e.e + o, (e.e < 0 || 6 < e.e) && (l = !0)) : r = o
                }
                i < 1 || i > Nt(n, o, s) ? D(t)._overflowWeeks = !0 : null != l ? D(t)._overflowWeekday = !0 : (a = Vt(n, i, r, o, s), t._a[pt] = a.year, t._dayOfYear = a.dayOfYear)
            }(t), null != t._dayOfYear && (o = de(t._a[pt], i[pt]), (t._dayOfYear > St(o) || 0 === t._dayOfYear) && (D(t)._overflowDayOfYear = !0), n = Lt(o, 0, t._dayOfYear), t._a[ft] = n.getUTCMonth(), t._a[gt] = n.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e) t._a[e] = s[e] = i[e];
            for (; e < 7; e++) t._a[e] = s[e] = null == t._a[e] ? 2 === e ? 1 : 0 : t._a[e];
            24 === t._a[vt] && 0 === t._a[yt] && 0 === t._a[mt] && 0 === t._a[wt] && (t._nextDay = !0, t._a[vt] = 0), t._d = (t._useUTC ? Lt : function (t, e, n, i, r, o, s) {
                var a = new Date(t, e, n, i, r, o, s);
                return t < 100 && 0 <= t && isFinite(a.getFullYear()) && a.setFullYear(t), a
            }).apply(null, s), r = t._useUTC ? t._d.getUTCDay() : t._d.getDay(), null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), t._nextDay && (t._a[vt] = 24), t._w && void 0 !== t._w.d && t._w.d !== r && (D(t).weekdayMismatch = !0)
        }
    }
    ...
    function me(t) {
        var e, n, i, r, o, s, a = t._i, l = he.exec(a) || pe.exec(a);
        if (l) {
            for (D(t).iso = !0, e = 0, n = ge.length; e < n; e++) if (ge[e][1].exec(l[1])) {
                r = ge[e][0], i = !1 !== ge[e][2];
                break
            }
    ...
    function be(t) {
        var e, n, i, r, o, s, a, l, u, d, c,
            h = we.exec(t._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s\s*/, "").replace(/\s\s*$/, ""));
        if (h) {
            var p = (r = h[4], o = h[3], s = h[2], a = h[5], l = h[6], u = h[7], c = [(d = parseInt(r, 10), d <= 49 ? 2e3 + d : d <= 999 ? 1900 + d : d), xt.indexOf(o), parseInt(s, 10), parseInt(a, 10), parseInt(l, 10)], u && c.push(parseInt(u, 10)), c);
            if (n = p, i = t, (e = h[1]) && Ut.indexOf(e) !== new Date(n[0], n[1], n[2]).getDay() && (D(i).weekdayMismatch = !0, !(i._isValid = !1))) return;
            t._a = p, t._tzm = function (t, e, n) {
                if (t) return De[t];
                if (e) return 0;
                var i = parseInt(n, 10), r = i % 100;
                return (i - r) / 100 * 60 + r
            }(h[8], h[9], h[10]), t._d = Lt.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), D(t).rfc2822 = !0
        } else t._isValid = !1
    }
    ...
    function Se(t) {
        if (t._f !== m.ISO_8601) if (t._f !== m.RFC_2822) {
            t._a = [], D(t).empty = !0;
            var e, n, i, r, o, s, a, l, u = "" + t._i, d = u.length, c = 0;
            for (i = U(t._f, t._locale).match(L) || [], e = 0; e < i.length; e++) r = i[e], (n = (u.match((v = r, y = t, w(at, v) ? at[v](y._strict, y._locale) : new RegExp(ut(v.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (t, e, n, i, r) {
                return e || n || i || r
            }))))) || [])[0]) && (0 < (o = u.substr(0, u.indexOf(n))).length && D(t).unusedInput.push(o), u = u.slice(u.indexOf(n) + n.length), c += n.length), B[r] ? (n ? D(t).empty = !1 : D(t).unusedTokens.push(r), s = r, l = t, null != (a = n) && w(dt, s) && dt[s](a, l._a, l, s)) : t._strict && !n && D(t).unusedTokens.push(r);
            D(t).charsLeftOver = d - c, 0 < u.length && D(t).unusedInput.push(u), t._a[vt] <= 12 && !0 === D(t).bigHour && 0 < t._a[vt] && (D(t).bigHour = void 0), D(t).parsedDateParts = t._a.slice(0), D(t).meridiem = t._meridiem, t._a[vt] = (h = t._locale, p = t._a[vt], null == (f = t._meridiem) ? p : null != h.meridiemHour ? h.meridiemHour(p, f) : (null != h.isPM && ((g = h.isPM(f)) && p < 12 && (p += 12), g || 12 !== p || (p = 0)), p)), ce(t), ue(t)
        } else be(t); else me(t);
        var h, p, f, g, v, y
    }

    function _e(t) {
        var e, n, i, r, o = t._i, s = t._f;
        return t._locale = t._locale || le(t._l), null === o || void 0 === s && "" === o ? v({nullInput: !0}) : ("string" == typeof o && (t._i = o = t._locale.preparse(o)), S(o) ? new b(ue(o)) : (c(o) ? t._d = o : a(s) ? function (t) {
            var e, n, i, r, o;
            if (0 === t._f.length) return D(t).invalidFormat = !0, t._d = new Date(NaN);
            for (r = 0; r < t._f.length; r++) o = 0, e = y({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[r], Se(e), g(e) && (o += D(e).charsLeftOver, o += 10 * D(e).unusedTokens.length, D(e).score = o, (null == i || o < i) && (i = o, n = e));
            p(t, n || e)
        }(t) : s ? Se(t) : u(n = (e = t)._i) ? e._d = new Date(m.now()) : c(n) ? e._d = new Date(n.valueOf()) : "string" == typeof n ? (i = e, null === (r = ye.exec(i._i)) ? (me(i), !1 === i._isValid && (delete i._isValid, be(i), !1 === i._isValid && (delete i._isValid, m.createFromInputFallback(i)))) : i._d = new Date(+r[1])) : a(n) ? (e._a = h(n.slice(0), function (t) {
        ...
        }(e) : d(n) ? e._d = new Date(n) : m.createFromInputFallback(e), g(t) || (t._d = null), t))
    }
    ...
    function Ee(t, e, n, i, r) {
        ...
        return !0 !== n && !1 !== n || (i = n, n = void 0), (l(t) && function (t) {
            ...
            return !0
        }(t) || a(t) && 0 === t.length) && (t = void 0), s._isAMomentObject = !0, s._useUTC = s._isUTC = r, s._l = n, s._i = t, s._f = e, s._strict = i, (o = new b(ue(_e(s))))._nextDay && (o.add(1, "d"), o._nextDay = void 0), o
    }
    ...
    function He(t) {
        var e = k(t), n = e.year || 0, i = e.quarter || 0, r = e.month || 0, o = e.week || 0, s = e.day || 0,
            a = e.hour || 0, l = e.minute || 0, u = e.second || 0, d = e.millisecond || 0;
        this._isValid = function (t) {
            ...
            return !0
        }(e), this._milliseconds = +d + 1e3 * u + 6e4 * l + 1e3 * a * 60 * 60, this._days = +s + 7 * o, this._months = +r + 3 * i + 12 * n, this._data = {}, this._locale = le(), this._bubble()
    }
    ...
    function Oe(t, n) {
        N(t, 0, 0, function () {
            ...
            return t < 0 && (t = -t, e = "-"), e + Y(~~(t / 60), 2) + n + Y(~~t % 60, 2)
        })
    }

    Oe("Z", ":"), Oe("ZZ", ""), lt("Z", ot), lt("ZZ", ot), ct(["Z", "ZZ"], function (t, e, n) {
    ...
    function Fe(t, e) {
        ...
        var i = ((n[n.length - 1] || []) + "").match(ke) || ["-", 0, 0], r = 60 * i[1] + E(i[2]);
        return 0 === r ? 0 : "+" === i[0] ? r : -r
    }

    function ze(t, e) {
        var n, i;
        return e._isUTC ? (n = e.clone(), i = (S(t) || c(t) ? t.valueOf() : Me(t).valueOf()) - n.valueOf(), n._d.setTime(n._d.valueOf() + i), m.updateOffset(n, !1), n) : Me(t).local()
    }
    ...
    function Be(t, e) {
        var n, i, r, o, s, a, l = t, u = null;
        return Ie(t) ? l = {
            ms: t._milliseconds,
            d: t._days,
            M: t._months
        } : d(t) ? (l = {}, e ? l[e] = t : l.milliseconds = t) : (u = Ae.exec(t)) ? (n = "-" === u[1] ? -1 : 1, l = {
            y: 0,
            d: E(u[gt]) * n,
            h: E(u[vt]) * n,
            m: E(u[yt]) * n,
            ...
            m: Ne(u[7], n),
            s: Ne(u[8], n)
        }) : null == l ? l = {} : "object" == typeof l && ("from" in l || "to" in l) && (o = Me(l.from), s = Me(l.to), r = o.isValid() && s.isValid() ? (s = ze(s, o), o.isBefore(s) ? a = Ge(o, s) : ((a = Ge(s, o)).milliseconds = -a.milliseconds, a.months = -a.months), a) : {
            milliseconds: 0,
            months: 0
        }, (l = {}).ms = r.milliseconds, l.M = r.months), i = new He(l), Ie(t) && w(t, "_locale") && (i._locale = t._locale), i
    }
    ...
    function Ue(i, r) {
        return function (t, e) {
            var n;
            return null === e || isNaN(+e) || (T(r, "moment()." + r + "(period, number) is deprecated. Please use moment()." + r + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), n = t, t = e, e = n), We(this, Be(t = "string" == typeof t ? +t : t, e), i), this
        }
    }

    function We(t, e, n, i) {
        var r = e._milliseconds, o = xe(e._days), s = xe(e._months);
        t.isValid() && (i = null == i || i, s && Ot(t, Tt(t, "Month") + s * n), o && Rt(t, "Date", Tt(t, "Date") + o * n), r && t._d.setTime(t._d.valueOf() + r * n), i && m.updateOffset(t, o || s))
    }

    Be.fn = He.prototype, Be.invalid = function () {
        return Be(NaN)
    };
    var je = Ue(1, "add"), qe = Ue(-1, "subtract");
    ...
    function Ke(t, e, n, i, r) {
        var o;
        return null == t ? Bt(this, i, r).year : ((o = Nt(t, i, r)) < e && (e = o), function (t, e, n, i, r) {
            var o = Vt(t, e, n, i, r), s = Lt(o.year, 0, o.dayOfYear);
    ...
    }), Je("gggg", "weekYear"), Je("ggggg", "weekYear"), Je("GGGG", "isoWeekYear"), Je("GGGGG", "isoWeekYear"), x("weekYear", "gg"), x("isoWeekYear", "GG"), z("weekYear", 1), z("isoWeekYear", 1), lt("G", it), lt("g", it), lt("GG", Q, j), lt("gg", Q, j), lt("GGGG", tt, Z), lt("gggg", tt, Z), lt("GGGGG", et, $), lt("ggggg", et, $), ht(["gggg", "ggggg", "GGGG", "GGGGG"], function (t, e, n, i) {
        e[i.substr(0, 2)] = E(t)
    }), ht(["gg", "GG"], function (t, e, n, i) {
        e[i] = m.parseTwoDigitYear(t)
    }), N("Q", 0, "Qo", "quarter"), x("quarter", "Q"), z("quarter", 7), lt("Q", W), ct("Q", function (t, e) {
        e[ft] = 3 * (E(t) - 1)
    }), N("D", ["DD", 2], "Do", "date"), x("date", "D"), z("date", 9), lt("D", Q), lt("DD", Q, j), lt("Do", function (t, e) {
        return t ? e._dayOfMonthOrdinalParse || e._ordinalParse : e._dayOfMonthOrdinalParseLenient
    }), ct(["D", "DD"], gt), ct("Do", function (t, e) {
        e[gt] = E(t.match(Q)[0])
    });
    var tn = Ct("Date", !0);
    N("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), x("dayOfYear", "DDD"), z("dayOfYear", 4), lt("DDD", K), lt("DDDD", q), ct(["DDD", "DDDD"], function (t, e, n) {
        n._dayOfYear = E(t)
    }), N("m", ["mm", 2], 0, "minute"), x("minute", "m"), z("minute", 14), lt("m", Q), lt("mm", Q, j), ct(["m", "mm"], yt);
    var en = Ct("Minutes", !1);
    N("s", ["ss", 2], 0, "second"), x("second", "s"), z("second", 15), lt("s", Q), lt("ss", Q, j), ct(["s", "ss"], mt);
    var nn, rn = Ct("Seconds", !1);
    ...
    }), x("millisecond", "ms"), z("millisecond", 16), lt("S", K, W), lt("SS", K, j), lt("SSS", K, q), nn = "SSSS"; nn.length <= 9; nn += "S") lt(nn, nt);
    ...
    an.add = je, an.calendar = function (t, e) {
        var n = t || Me(), i = ze(n, this).startOf("day"), r = m.calendarFormat(this, i) || "sameElse",
        ...
        return this.isValid() && (S(t) && t.isValid() || Me(t).isValid()) ? Be({
            to: this,
            from: t
        ...
        var n = S(t) ? t : Me(t);
        return !(!this.isValid() || !n.isValid()) && ("millisecond" === (e = O(u(e) ? "millisecond" : e)) ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(e).valueOf())
    }, an.isBefore = function (t, e) {
        var n = S(t) ? t : Me(t);
        return !(!this.isValid() || !n.isValid()) && ("millisecond" === (e = O(u(e) ? "millisecond" : e)) ? this.valueOf() < n.valueOf() : this.clone().endOf(e).valueOf() < n.valueOf())
        ...
        return g(this)
    }, an.lang = Qe, an.locale = $e, an.localeData = Xe, an.max = Te, an.min = Ce, an.parsingFlags = function () {
        return p({}, D(this))
    }, an.set = function (t, e) {
        ...
        }(t = k(t)), i = 0; i < n.length; i++) this[n[i].unit](t[n[i].unit]); else if (R(this[t = O(t)])) return this[t](e);
        return this
    ...
    }, an.subtract = qe, an.toArray = function () {
        var t = this;
        ...
        return n.year() < 0 || 9999 < n.year() ? G(n, e ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : R(Date.prototype.toISOString) ? e ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", G(n, "Z")) : G(n, e ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
    }, an.inspect = function () {
    ...
    }, an.year = Mt, an.isLeapYear = function () {
        return _t(this.year())
    ...
    }, an.month = kt, an.daysInMonth = function () {
        ...
        return !this._isUTC && e && (i = Ye(this)), this._offset = t, this._isUTC = !0, null != i && this.add(i, "m"), r !== t && (!e || this._changeInProgress ? We(this, Be(t - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, m.updateOffset(this, !0), this._changeInProgress = null)), this
    }, an.utc = function (t) {
        ...
        return !!this.isValid() && this._isUTC
    }, an.isUtc = Le, an.isUTC = Le, an.zoneAbbr = function () {
        return this._isUTC ? "UTC" : ""
    }, an.zoneName = function () {
        return this._isUTC ? "Coordinated Universal Time" : ""
    }, an.dates = n("dates accessor is deprecated. Use date instead.", tn), an.months = n("months accessor is deprecated. Use month instead", kt), an.years = n("years accessor is deprecated. Use year instead", Mt), an.zone = n("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function (t, e) {
    ...
    function dn(t, e, n, i) {
        var r = le(), o = f().set(i, e);
        return r[n](o, t)
    }

    function cn(t, e, n) {
        if (d(t) && (e = t, t = void 0), t = t || "", null != e) return dn(t, e, n, "month");
        var i, r = [];
    ...
    function hn(t, e, n, i) {
        "boolean" == typeof t ? d(e) && (n = e, e = void 0) : (e = t, t = !1, d(n = e) && (n = e, e = void 0)), e = e || "";
        var r, o = le(), s = t ? o._week.dow : 0;
    ...
    un.calendar = function (t, e, n) {
        ...
        return t ? a(this._months) ? this._months[t.month()] : this._months[(this._months.isFormat || Ht).test(e) ? "format" : "standalone"][t.month()] : a(this._months) ? this._months : this._months.standalone
    }, un.monthsShort = function (t, e) {
        return t ? a(this._monthsShort) ? this._monthsShort[t.month()] : this._monthsShort[Ht.test(e) ? "format" : "standalone"][t.month()] : a(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone
        ...
        if (this._monthsParseExact) return function (t, e, n) {
            ...
            return n ? "MMM" === e ? -1 !== (r = Et.call(this._shortMonthsParse, s)) ? r : null : -1 !== (r = Et.call(this._longMonthsParse, s)) ? r : null : "MMM" === e ? -1 !== (r = Et.call(this._shortMonthsParse, s)) ? r : -1 !== (r = Et.call(this._longMonthsParse, s)) ? r : null : -1 !== (r = Et.call(this._longMonthsParse, s)) ? r : -1 !== (r = Et.call(this._shortMonthsParse, s)) ? r : null
        }.call(this, t, e, n);
        ...
        return this._monthsParseExact ? (w(this, "_monthsRegex") || Yt.call(this), t ? this._monthsStrictRegex : this._monthsRegex) : (w(this, "_monthsRegex") || (this._monthsRegex = zt), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
    }, un.monthsShortRegex = function (t) {
        return this._monthsParseExact ? (w(this, "_monthsRegex") || Yt.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (w(this, "_monthsShortRegex") || (this._monthsShortRegex = Ft), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
    }, un.week = function (t) {
        ...
        return this._weekdaysParseExact ? (w(this, "_weekdaysRegex") || $t.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (w(this, "_weekdaysRegex") || (this._weekdaysRegex = jt), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
    }, un.weekdaysShortRegex = function (t) {
        return this._weekdaysParseExact ? (w(this, "_weekdaysRegex") || $t.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (w(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = qt), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
    }, un.weekdaysMinRegex = function (t) {
        return this._weekdaysParseExact ? (w(this, "_weekdaysRegex") || $t.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (w(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Zt), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
    }, un.isPM = function (t) {
    ...
    }), m.lang = n("moment.lang is deprecated. Use moment.locale instead.", se), m.langData = n("moment.langData is deprecated. Use moment.localeData instead.", le);
    var pn = Math.abs;
    ...
    var wn = mn("ms"), Dn = mn("s"), bn = mn("m"), Sn = mn("h"), _n = mn("d"), En = mn("w"), Mn = mn("M"), Cn = mn("y");
    ...
    var Rn = Tn("milliseconds"), Pn = Tn("seconds"), Hn = Tn("minutes"), In = Tn("hours"), xn = Tn("days"),
        On = Tn("months"), kn = Tn("years"), Fn = Math.round, zn = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11},
        Yn = Math.abs;
    ...
    function An() {
        ...
        var t, e, n = Yn(this._milliseconds) / 1e3, i = Yn(this._days), r = Yn(this._months);
        e = _((t = _(n / 60)) / 60), n %= 60, t %= 60;
        var o = _(r / 12), s = r %= 12, a = i, l = e, u = t, d = n ? n.toFixed(3).replace(/\.?0+$/, "") : "",
            c = this.asSeconds();
        if (!c) return "P0D";
        var h = c < 0 ? "-" : "", p = Ln(this._months) !== Ln(c) ? "-" : "", f = Ln(this._days) !== Ln(c) ? "-" : "",
            g = Ln(this._milliseconds) !== Ln(c) ? "-" : "";
        return h + "P" + (o ? p + o + "Y" : "") + (s ? p + s + "M" : "") + (a ? f + a + "D" : "") + (l || u || d ? "T" : "") + (l ? g + l + "H" : "") + (u ? g + u + "M" : "") + (d ? g + d + "S" : "")
    }
    ...
    return Vn.isValid = function () {
        ...
        var t = this._data;
        return this._milliseconds = pn(this._milliseconds), this._days = pn(this._days), this._months = pn(this._months), t.milliseconds = pn(t.milliseconds), t.seconds = pn(t.seconds), t.minutes = pn(t.minutes), t.hours = pn(t.hours), t.months = pn(t.months), t.years = pn(t.years), this
    }, Vn.add = function (t, e) {
        ...
        if ("month" === (t = O(t)) || "year" === t) return e = this._days + i / 864e5, n = this._months + vn(e), "month" === t ? n : n / 12;
    ...
    }, Vn.asMilliseconds = wn, Vn.asSeconds = Dn, Vn.asMinutes = bn, Vn.asHours = Sn, Vn.asDays = _n, Vn.asWeeks = En, Vn.asMonths = Mn, Vn.asYears = Cn, Vn.valueOf = function () {
        ...
        return 0 <= o && 0 <= s && 0 <= a || o <= 0 && s <= 0 && a <= 0 || (o += 864e5 * gn(yn(a) + s), a = s = 0), l.milliseconds = o % 1e3, t = _(o / 1e3), l.seconds = t % 60, e = _(t / 60), l.minutes = e % 60, n = _(e / 60), l.hours = n % 24, a += r = _(vn(s += _(n / 24))), s -= gn(yn(r)), i = _(a / 12), a %= 12, l.days = s, l.months = a, l.years = i, this
    }, Vn.clone = function () {
        return Be(this)
    }, Vn.get = function (t) {
        return t = O(t), this.isValid() ? this[t + "s"]() : NaN
    }, Vn.milliseconds = Rn, Vn.seconds = Pn, Vn.minutes = Hn, Vn.hours = In, Vn.days = xn, Vn.weeks = function () {
        return _(this.days() / 7)
    }, Vn.months = On, Vn.years = kn, Vn.humanize = function (t) {
        if (!this.isValid()) return this.localeData().invalidDate();
        var e, n, i, r, o, s, a, l, u, d, c = this.localeData(),
            h = (e = !t, n = c, i = Be(this).abs(), r = Fn(i.as("s")), o = Fn(i.as("m")), s = Fn(i.as("h")), a = Fn(i.as("d")), l = Fn(i.as("M")), u = Fn(i.as("y")), (d = r <= zn.ss && ["s", r] || r < zn.s && ["ss", r] || o <= 1 && ["m"] || o < zn.m && ["mm", o] || s <= 1 && ["h"] || s < zn.h && ["hh", s] || a <= 1 && ["d"] || a < zn.d && ["dd", a] || l <= 1 && ["M"] || l < zn.M && ["MM", l] || u <= 1 && ["y"] || ["yy", u])[2] = e, d[3] = 0 < +this, d[4] = n, function (t, e, n, i, r) {
                return r.relativeTime(e || 1, !!n, t, i)
            }.apply(null, d));
        return t && (h = c.pastFuture(+this, h)), c.postformat(h)
    }, Vn.toISOString = An, Vn.toString = An, Vn.toJSON = An, Vn.locale = $e, Vn.localeData = Xe, Vn.toIsoString = n("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", An), Vn.lang = Qe, N("X", 0, 0, "unix"), N("x", 0, 0, "valueOf"), lt("x", it), lt("X", /[+-]?\d+(\.\d{1,3})?/), ct("X", function (t, e, n) {
        n._d = new Date(1e3 * parseFloat(t, 10))
    }), ct("x", function (t, e, n) {
        n._d = new Date(E(t))
    }), m.version = "2.22.2", t = Me, m.fn = an, m.min = function () {
    ...
    }, m.isDate = c, m.locale = se, m.invalid = v, m.duration = Be, m.isMoment = S, m.weekdays = function (t, e, n) {
        return hn(t, e, n, "weekdays")
    }, m.parseZone = function () {
        return Me.apply(null, arguments).parseZone()
    }, m.localeData = le, m.isDuration = Ie, m.monthsShort = function (t, e) {
        return cn(t, e, "monthsShort")
    }, m.weekdaysMin = function (t, e, n) {
        return hn(t, e, n, "weekdaysMin")
    }, m.defineLocale = ae, m.updateLocale = function (t, e) {
        if (null != e) {
            var n, i, r = ee;
            null != (i = oe(t)) && (r = i._config), (n = new H(e = P(r, e))).parentLocale = ne[t], ne[t] = n, se(t)
    ...
    }, m.normalizeUnits = O, m.relativeTimeRounding = function (t) {
    ...
    return function (n) {
        ...
        function s(t) {
            var e, n, i, r = t[0].offsetWidth - t[0].clientWidth, o = t[0].offsetHeight - t[0].clientHeight;
            return r = a(r), e = {
                left: 0,
                right: 0,
                top: 0,
                bottom: o = a(o)
            }, null === m && (n = y("<div><div/></div>").css({
                position: "absolute",
                top: -1e3,
                left: 0,
                border: 0,
                ...
                overflow: "scroll",
                direction: "rtl"
            }).appendTo("body"), i = n.children().offset().left > n.offset().left, n.remove(), m = i), m && "rtl" === t.css("direction") ? e.left = r : e.right = r, e
        }
        ...
        function d(t, e, n, i, r) {
            ...
            return null == o && i && (o = i[n.field]), null == s && r && (s = r[n.field]), c(o, s) * (n.order || 1)
        }

        function c(t, e) {
            return t || e ? null == e ? -1 : null == t ? 1 : "string" === y.type(t) || "string" === y.type(e) ? String(t).localeCompare(String(e)) : t - e : 0
        }

        function r(t, e) {
            var n, i, r, o, s, a;
            for (n = 0; n < l.unitsDesc.length && (i = l.unitsDesc[n], o = i, s = t, !(1 <= (r = null != (a = e) ? a.diff(s, o, !0) : v.isDuration(s) ? s.as(o) : s.end.diff(s.start, o, !0)) && g(r))); n++) ;
            return i
        }
        ...
        l.compensateScroll = function (t, e) {
            ...
            y("body").addClass("fc-not-allowed")
        }, l.enableCursor = function () {
            y("body").removeClass("fc-not-allowed")
        }, l.distributeHeight = function (r, t, e) {
            var o = Math.floor(t / r.length), s = Math.floor(t - o * (r.length - 1)), a = [], l = [], u = [], d = 0;
            n(r), r.each(function (t, e) {
                var n = t === r.length - 1 ? s : o, i = y(e).outerHeight(!0);
                i < n ? (a.push(e), l.push(i), u.push(y(e).height())) : d += i
            }), e && (t -= d, o = Math.floor(t / a.length), s = Math.floor(t - o * (a.length - 1))), y(a).each(function (t, e) {
                var n = t === a.length - 1 ? s : o, i = l[t], r = n - (i - u[t]);
                i < n && y(e).height(r)
            })
        }, l.undistributeHeight = n, l.matchCellWidths = function (t) {
            var i = 0;
            return t.find("> *").each(function (t, e) {
                var n = y(e).outerWidth();
                i < n && (i = n)
            }), i++, t.width(i), i
            ...
            return "fixed" !== e && n.length ? n : y(t[0].ownerDocument || document)
            ...
            var n = t.offset(), i = s(t), r = n.left + u(t, "border-left-width") + i.left - (e ? e.left : 0),
                o = n.top + u(t, "border-top-width") + i.top - (e ? e.top : 0);
            return {left: r, right: r + t[0].clientWidth, top: o, bottom: o + t[0].clientHeight}
        }, l.getContentRect = function (t, e) {
            var n = t.offset(), i = n.left + u(t, "border-left-width") + u(t, "padding-left") - (e ? e.left : 0),
                r = n.top + u(t, "border-top-width") + u(t, "padding-top") - (e ? e.top : 0);
            return {left: i, right: i + t.width(), top: r, bottom: r + t.height()}
        }, l.getScrollbarWidths = s;
        var m = null;
        l.isPrimaryMouseButton = function (t) {
            ...
            t.addClass("fc-unselectable").on("selectstart", i)
        }, l.allowSelection = function (t) {
            t.removeClass("fc-unselectable").off("selectstart", i)
        }, l.preventDefault = i, l.intersectRects = function (t, e) {
            var n = {
            ...
            var e, n, i = [], r = [];
            for ("string" == typeof t ? r = t.split(/\s*,\s*/) : "function" == typeof t ? r = [t] : y.isArray(t) && (r = t), e = 0; e < r.length; e++) "string" == typeof (n = r[e]) ? i.push("-" === n.charAt(0) ? {
                field: n.substring(1),
                order: -1
            } : {field: n, order: 1}) : "function" == typeof n && i.push({func: n});
            return i
        }, l.compareByFieldSpecs = function (t, e, n, i, r) {
            var o, s;
            for (o = 0; o < n.length; o++) if (s = d(t, e, n[o], i, r)) return s;
            return 0
        }, l.compareByFieldSpec = d, l.flexibleCompare = c, l.dayIDs = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], l.unitsDesc = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], l.diffDayTime = function (t, e) {
            return v.duration({
                days: t.clone().stripTime().diff(e.clone().stripTime(), "days"),
                ms: t.time() - e.time()
            })
        }, l.diffDay = function (t, e) {
            return v.duration({days: t.clone().stripTime().diff(e.clone().stripTime(), "days")})
        }, l.diffByUnit = function (t, e, n) {
            return v.duration(Math.round(t.diff(e, n, !0)), n)
        }, l.computeGreatestUnit = r, l.computeDurationGreatestUnit = function (t, e) {
            var n = r(t);
            return "week" === n && "object" == typeof e && e.days && (n = "day"), n
        }, l.divideRangeByDuration = function (t, e, n) {
            var i;
            return o(n) ? (e - t) / n : (i = n.asMonths(), 1 <= Math.abs(i) && g(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
        }, l.divideDurationByDuration = function (t, e) {
            var n, i;
            return o(t) || o(e) ? t / e : (n = t.asMonths(), i = e.asMonths(), 1 <= Math.abs(n) && g(n) && 1 <= Math.abs(i) && g(i) ? n / i : t.asDays() / e.asDays())
        }, l.multiplyDuration = function (t, e) {
            var n;
            return o(t) ? v.duration(t * e) : (n = t.asMonths(), 1 <= Math.abs(n) && g(n) ? v.duration({months: n * e}) : v.duration({days: t.asDays() * e}))
        }, l.durationHasTime = o, l.isNativeDate = function (t) {
            return "[object Date]" === Object.prototype.toString.call(t) || t instanceof Date
        }, l.isTimeString = function (t) {
            return "string" == typeof t && /^\d+\:\d+(?:\:\d+\.?(?:\d{3})?)?$/.test(t)
        }, l.log = h, l.warn = function () {
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            var n = window.console;
            return n && n.warn ? n.warn.apply(n, t) : h.apply(null, t)
        };
        var w = {}.hasOwnProperty;
        l.mergeProps = function t(e, n) {
            var i, r, o, s, a, l, u = {};
            if (n) for (i = 0; i < n.length; i++) {
                for (r = n[i], o = [], s = e.length - 1; 0 <= s; s--) if ("object" == typeof (a = e[s][r])) o.unshift(a); else if (void 0 !== a) {
                    u[r] = a;
                    break
                }
                o.length && (u[r] = t(o))
            }
            for (i = e.length - 1; 0 <= i; i--) for (r in l = e[i]) r in u || (u[r] = l[r]);
            return u
        }, l.copyOwnProps = function (t, e) {
            for (var n in t) p(t, n) && (e[n] = t[n])
        }, l.hasOwnProp = p, l.applyAll = function (t, e, n) {
            if (y.isFunction(t) && (t = [t]), t) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), s = n(208), i = n(33), a = n(49), l = function (n) {
            function i(t) {
        ...
        function i(t, e, n) {
            ...
            var i, r, o, s, a = t[0], l = 1 === t.length && "string" == typeof a;
            return u.isMoment(a) || c.isNativeDate(a) || void 0 === a ? s = u.apply(null, t) : (r = i = !1, l ? h.test(a) ? (t = [a += "-01"], r = i = !0) : (o = p.exec(a)) && (i = !o[5], r = !0) : d.isArray(a) && (r = !0), s = e || i ? u.utc.apply(u, t) : u.apply(null, t), i ? (s._ambigTime = !0, s._ambigZone = !0) : n && (r ? s._ambigZone = !0 : l && s.utcOffset(a))), s._fullCalendar = !0, s
        }

        Object.defineProperty(e, "__esModule", {value: !0});
        var u = n(0), d = n(3), c = n(4), h = /^\s*\d{4}-\d\d$/,
            p = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/,
            r = u.fn;
        e.newMomentProto = r;
        var o = d.extend({}, r);
        e.oldMomentProto = o;
        var s = u.momentProperties;
        s.push("_fullCalendar"), s.push("_ambigTime"), s.push("_ambigZone"), e.oldMomentFormat = function (t, e) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), i = n(34), o = n(209), s = n(17), a = function (i) {
            function t() {
            ...
            return r.__extends(t, i), t.prototype.buildInstances = function () {
                ...
                var e = i.prototype.applyManualStandardProps.call(this, t), n = s.default.parse(t, this.source);
        ...
        var i = n(5), r = function () {
            ...
            return u.parse = function (t, e) {
                ...
                if (!n) return !1;
                var r = e.calendar, o = r.moment(n), s = i ? r.moment(i) : null, a = t.allDay,
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(5), r = n(35), s = n(211), o = function () {
            function t(t) {
            ...
            return t.prototype.getAllEventRanges = function (t) {
                ...
                var e, n, i, r = this.eventInstances, o = [];
        ...
        function i(e, n) {
            e.then = function (t) {
                return "function" == typeof t ? s.resolve(t(n)) : e
            }
        }
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var s = n(2), a = n(4), o = function (o) {
            function t(t, e) {
                var n = o.call(this, e) || this;
                return n.component = t, n
            }

            return s.__extends(t, o), t.prototype.handleInteractionStart = function (t) {
                var e, n, i, r = this.subjectEl;
                this.component.hitsNeeded(), this.computeScrollBounds(), t ? (i = n = {
                    left: a.getEvX(t),
                    top: a.getEvY(t)
                }, r && (e = a.getOuterRect(r), i = a.constrainPoint(i, e)), this.origHit = this.queryHit(i.left, i.top), r && this.options.subjectCenter && (this.origHit && (e = a.intersectRects(this.origHit, e) || e), i = a.getRectCenter(e)), this.coordAdjust = a.diffPoints(i, n)) : (this.origHit = null, this.coordAdjust = null), o.prototype.handleInteractionStart.call(this, t)
                ...
                var i;
                o.prototype.handleDrag.call(this, t, e, n), r(i = this.queryHit(a.getEvX(n), a.getEvY(n)), this.hit) || (this.hit && this.handleHitOut(), i && this.handleHitOver(i))
        ...
        function n(t, e) {
            var n, i;
            n = o.localeOptionHash[t] || (o.localeOptionHash[t] = {}), e && (n = o.localeOptionHash[t] = l.mergeOptions([n, e])), i = r(t), s.each(c, function (t, e) {
                null == n[t] && (n[t] = e(i, n))
        ...
        var s = e(3), i = e(0), a = e(16), l = e(32), u = e(4);
        o.localeOptionHash = {}, a.locales = o.localeOptionHash;
        var d = {
            buttonText: function (t) {
                return {
                    prev: u.stripHtmlEntities(t.prevText),
                    next: u.stripHtmlEntities(t.nextText),
                    today: u.stripHtmlEntities(t.currentText)
                }
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var g = n(4), v = n(17), y = n(34), m = n(50), i = n(13), r = function () {
            function f() {
            }

            return f.createFromRawProps = function (t, e, n) {
                var i, r, o, s, a = t.def, l = {}, u = {}, d = {}, c = {}, h = null, p = null;
                for (i in e) v.default.isStandardProp(i) ? l[i] = e[i] : a.isStandardProp(i) ? u[i] = e[i] : a.miscProps[i] !== e[i] && (d[i] = e[i]);
                return (r = v.default.parse(l, a.source)) && (o = m.default.createFromDiff(t.dateProfile, r, n)), u.id !== a.id && (h = u.id), g.isArraysEqual(u.className, a.className) || (p = u.className), y.default.copyVerbatimStandardProps(u, c), (s = new f).eventDefId = h, s.className = p, s.verbatimStandardProps = c, s.miscProps = d, o && (s.dateMutation = o), s
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(3), o = n(4), s = function (n) {
            function t(t) {
                var e = n.call(this) || this;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), s = n(4), i = n(219), a = n(21), l = function (i) {
            function t(t, e) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), s = n(0), a = n(4), l = n(218), i = n(221), u = n(40), d = n(21), c = n(5),
            h = function (i) {
                function t(t, e) {
                ...
                return r.__extends(t, i), t.prototype._getView = function () {
                    ...
                    i.prototype.executeDateRender.call(this, t), this.render && this.render(), this.trigger("datesRendered"), this.addScroll({isDateInit: !0}), this.startNowIndicator()
                    ...
                    var r = this.calendar.eventManager.mutateEventsWithId(t.def.id, e), o = e.dateMutation;
        ...
        (e.default = h).prototype.usesMinMaxTime = !1, h.prototype.dateProfileGeneratorClass = i.default, h.watch("displayingDates", ["isInDom", "dateProfile"], function (t) {
            ...
            return t.prototype.opt = function (t) {
                ...
                this.fillRenderer.renderSegs("bgEvent", t, {
                    getClasses: function (t) {
                        ...
                        return {"background-color": n.getBgColor(t.footprint.eventDef)}
                ...
                var n = t.footprint, i = e.footprint, r = n.componentFootprint, o = i.componentFootprint,
                    s = r.unzonedRange, a = o.unzonedRange;
        ...
        function r(t, e) {
            return w(m(o(e).fakeFormatString, t).join(""))
        }
        ...
        function o(t) {
            return g[t] || (g[t] = {
                fakeFormatString: function t(e) {
                    var n, i, r = [];
                    for (n = 0; n < e.length; n++) "string" == typeof (i = e[n]) ? r.push("[" + i + "]") : i.token ? i.token in p ? r.push(d + "[" + i.token + "]") : r.push(i.token) : i.maybe && r.push(c + t(i.maybe) + c);
                    return r.join(u)
                }(e = s(t)), sameUnits: function t(e) {
                    var n, i, r, o = [];
                    for (n = 0; n < e.length; n++) (i = e[n]).token ? (r = f[i.token.charAt(0)], o.push(r ? r.unit : "second")) : i.maybe ? o.push.apply(o, t(i.maybe)) : o.push(null);
                    return o
                }(e)
            });
            var e
        ...
        function s(t) {
            for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);) e[1] ? n.push.apply(n, a(e[1])) : e[2] ? n.push({maybe: s(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push.apply(n, a(e[5]));
            return n
        }
        ...
        function m(t, e) {
            var n, i, r = [], o = l.oldMomentFormat(e, t).split(u);
            for (n = 0; n < o.length; n++) (i = o[n]).charAt(0) === d ? r.push(p[i.substring(1)](e)) : r.push(i);
            return r
        }
        ...
        l.newMomentProto.format = function () {
            return this._fullCalendar && arguments[0] ? r(this, arguments[0]) : this._ambigTime ? l.oldMomentFormat(i(this), "YYYY-MM-DD") : this._ambigZone ? l.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss") : this._fullCalendar ? l.oldMomentFormat(i(this)) : l.oldMomentProto.format.apply(this, arguments)
        }, l.newMomentProto.toISOString = function () {
            return this._ambigTime ? l.oldMomentFormat(i(this), "YYYY-MM-DD") : this._ambigZone ? l.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss") : this._fullCalendar ? l.oldMomentProto.toISOString.apply(i(this), arguments) : l.oldMomentProto.toISOString.apply(this, arguments)
        };
        var u = "\v", d = "", c = "", h = new RegExp(c + "([^" + c + "]*)" + c, "g"), p = {
            t: function (t) {
        ...
        e.formatDate = r, e.formatRange = function (t, e, n, i, r) {
            return t = l.default.parseZone(t), e = l.default.parseZone(e), function (t, e, n, i, r) {
                var o, s, a, l = t.sameUnits, u = e.clone().stripZone(), d = n.clone().stripZone(),
                    c = m(t.fakeFormatString, e), h = m(t.fakeFormatString, n), p = "", f = "", g = "", v = "", y = "";
                for (o = 0; o < l.length && (!l[o] || u.isSame(d, l[o])); o++) p += c[o];
                for (s = l.length - 1; o < s && (!l[s] || u.isSame(d, l[s])) && (s - 1 !== o || "." !== c[s]); s--) f = c[s] + f;
                for (a = o; a <= s; a++) g += c[a], v += h[a];
                return (g || v) && (y = r ? v + i + g : g + i + v), w(p + y + f)
            }(o(n = t.localeData().longDateFormat(n) || n), t, e, i || " - ", r)
        };
        var g = {};
        e.queryMostGranularFormatUnit = function (t) {
            var e, n, i, r, o = s(t);
            for (e = 0; e < o.length; e++) (n = o[e]).token && (i = f[n.token.charAt(0)]) && (!r || i.value > r.value) && (r = i);
            return r ? r.unit : null
        }
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(33), o = n(11), s = n(7), a = function (e) {
            function t() {
            ...
            return i.__extends(t, e), t.watch = function (t) {
                ...
                var n = this, a = 0, l = t.length, u = 0, d = {}, i = [], c = !1, h = function (t, e) {
                    n.on(t, e), i.push([t, e])
                };
                return t.forEach(function (r) {
                    var o = !1;
                    "?" === r.charAt(0) && (r = r.substring(1), o = !0), h("before:change:" + r, function (t) {
                        1 == ++a && u === l && (c = !0, e(d), c = !1)
        ...
        var c = n(4), o = n(17), i = function () {
            ...
            return d.createFromDiff = function (t, n, i) {
                ...
                var r, o, s, a = t.end && !n.end, l = t.isAllDay() && !n.isAllDay(), u = !t.isAllDay() && n.isAllDay();
                return r = e(n.start, t.start), n.end && (o = e(n.unzonedRange.getEnd(), t.unzonedRange.getEnd()).subtract(r)), (s = new d).clearEnd = a, s.forceTimed = l, s.forceAllDay = u, s.setDateDelta(r), s.setEndDelta(o), s
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(3), o = n(4), s = n(20), a = n(6), l = n(13), u = function (n) {
            function t(t) {
        ...
        var a = n(3), i = n(4), r = function () {
            ...
            return t.prototype.build = function () {
                ...
                this.els.each(function (t, e) {
                    var n = a(e), i = n.offset().left, r = n.outerWidth();
                    o.push(i), s.push(i + r)
                }), this.lefts = o, this.rights = s
            }, t.prototype.buildElVerticals = function () {
                var o = [], s = [];
                this.els.each(function (t, e) {
                    var n = a(e), i = n.offset().top, r = n.outerHeight();
                    o.push(i), s.push(i + r)
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(3), u = n(4), r = n(7), o = n(21), s = function () {
            function t(t) {
            ...
            return t.prototype.startInteraction = function (t, e) {
                ...
                }), this.listenTo(t, {selectstart: u.preventDefault, contextmenu: u.preventDefault})
                ...
                var e = u.getEvX(t) - this.originX, n = u.getEvY(t) - this.originY, i = this.minDistance;
                ...
                var e, n, i, r, o = this.scrollSensitivity, s = this.scrollBounds, a = 0, l = 0;
        ...
        var i = n(2), l = n(4), r = function (t) {
            ...
            return i.__extends(e, t), e.prototype.updateDayTable = function () {
                ...
                var e, n, i, r, o, s, a = this.daysPerRow, l = this.view.computeDayRange(t),
                    ...
                    c = [];
                for (e = 0; e < this.rowCnt; e++) for (i = (n = e * a) + a - 1, r = n; r <= i; r++) o = Math.max(u, r), s = Math.min(d, r), (o = Math.ceil(o)) <= (s = Math.floor(s)) && c.push({
                    row: e,
                ...
                var i, r = this, o = r.view, s = r.dateProfile.activeUnzonedRange.containsDate(t),
        ...
        var l = n(3), o = n(4), i = function () {
            ...
            return t.prototype.renderFootprint = function (t, e, n) {
                ...
                var i = n.getClasses ? n.getClasses(e) : [], r = o.cssToStr(n.getCss ? n.getCss(e) : {});
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var o = n(13), s = n(36), a = n(6), i = function () {
            function t(t, e) {
            ...
            return t.prototype.renderComponentFootprint = function (t) {
                ...
                var e, n = this.view.calendar, i = n.footprintToDateProfile(t), r = new o.default(new a.default(n));
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), S = n(3), l = n(4), s = n(53), u = n(249), d = n(5), c = n(12), h = n(36), r = n(56), o = n(60),
            a = n(40), p = n(55), f = n(250), g = n(251), v = n(252), y = function (n) {
                function t(t) {
                    var e = n.call(this, t) || this;
                ...
                return i.__extends(t, n), t.prototype.componentFootprintToSegs = function (t) {
                    ...
                    function e(t, e) {
                        r = Math.max(r, S(e).outerHeight())
                    }

                    var n, i, r, o = this.rowEls.eq(t).height(), s = this.eventRenderer.rowStructs[t].tbodyEl.children();
                    for (n = 0; n < s.length; n++) if (i = s.eq(n).removeClass("fc-limited"), r = 0, i.find("> td > :first-child").each(e), i.position().top + r > o) return n;
                    return !1
                }, t.prototype.limitRow = function (e, n) {
                    var t, i, r, o, s, a, l, u, d, c, h, p, f, g, v, y = this, m = this.eventRenderer.rowStructs[e], w = [],
                        D = 0, b = function (t) {
                            for (; D < t;) (a = y.getCellSegs(e, D, n)).length && (d = i[n - 1][D], v = y.renderMoreLink(e, D, a), g = S("<div/>").append(v), d.append(g), w.push(g[0])), D++
                        };
                    if (n && n < m.segLevels.length) {
                        for (t = m.segLevels[n - 1], i = m.cellMatrix, r = m.tbodyEl.children().slice(n).addClass("fc-limited").get(), o = 0; o < t.length; o++) {
                            for (b((s = t[o]).leftCol), u = [], l = 0; D <= s.rightCol;) a = this.getCellSegs(e, D, n), u.push(a), l += a.length, D++;
                            if (l) {
                                for (c = (d = i[n - 1][s.leftCol]).attr("rowspan") || 1, h = [], p = 0; p < u.length; p++) f = S('<td class="fc-more-cell"/>').attr("rowspan", c), a = u[p], v = this.renderMoreLink(e, s.leftCol + p, [s].concat(a)), g = S("<div/>").append(v), f.append(g), h.push(f[0]), w.push(f[0]);
                    ...
                    var c = this, h = this.view;
                    return S('<a class="fc-more"/>').text(this.getMoreLinkText(d.length)).on("click", function (t) {
                        var e = c.opt("eventLimitClick"), n = c.getCellDate(l, u), i = S(t.currentTarget),
                            r = c.getCellEl(l, u), o = c.getCellSegs(l, u), s = c.resliceDaySegs(o, n),
                            a = c.resliceDaySegs(d, n);
                        "function" == typeof e && (e = c.publiclyTrigger("eventLimitClick", {
                            context: h,
                            args: [{date: n.clone(), dayEl: r, moreEl: i, segs: s, hiddenSegs: a}, t, h]
                        })), "popover" === e ? c.showSegPopover(l, u, i, s) : "string" == typeof e && h.calendar.zoomTo(n, e)
                    })
                }, t.prototype.showSegPopover = function (t, e, n, i) {
                    var r, o, s = this, a = this.view, l = n.parent();
                    ...
                    var i, r = this.view.calendar.theme, o = this.getCellDate(t, e).format(this.opt("dayPopoverFormat")),
                        s = S('<div class="fc-header ' + r.getClass("popoverHeader") + '"><span class="fc-close ' + r.getIconClass("close") + '"></span><span class="fc-title">' + l.htmlEscape(o) + '</span><div class="fc-clear"/></div><div class="fc-body ' + r.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>'),
                    ...
                    var n, i, r, o = e.clone(), s = o.clone().add(1, "days"), a = new d.default(o, s), l = [];
                    for (n = 0; n < t.length; n++) (r = (i = t[n]).footprint.componentFootprint.unzonedRange.intersect(a)) && l.push(S.extend({}, i, {
                        footprint: new h.default(new c.default(r, i.footprint.componentFootprint.isAllDay), i.footprint.eventDef, i.footprint.eventInstance),
        ...
        (e.default = y).prototype.eventRendererClass = f.default, y.prototype.businessHourRendererClass = r.default, y.prototype.helperRendererClass = g.default, y.prototype.fillRendererClass = v.default, o.default.mixInto(y), p.default.mixInto(y)
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(3), l = n(4), o = n(39), s = n(41), a = n(228), u = n(61), d = function (a) {
            function t(t, e) {
            ...
            return i.__extends(t, a), t.prototype.instantiateDayGrid = function () {
                ...
                var i, r, o = this.opt("eventLimit"), s = this.dayGrid.headContainerEl.find(".fc-row");
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(5), r = n(12), o = n(49), s = n(6), u = n(35), a = function () {
            function t(t, e) {
            ...
            return t.prototype.opt = function (t) {
                ...
                var e, n = t.getEventDef(), i = this.eventRangesToEventFootprints(t.getAllEventRanges()),
                    ...
                    o = this.eventRangesToEventFootprints(r), s = n.getConstraint(), a = n.getOverlap(),
                    l = this.opt("eventAllow");
                for (e = 0; e < i.length; e++) if (!this.isFootprintAllowed(i[e].componentFootprint, o, s, a, i[e].eventInstance)) return !1;
                if (l) for (e = 0; e < i.length; e++) if (!1 === l(i[e].componentFootprint.toLegacy(this._calendar), i[e].getEventLegacy())) return !1;
                return !0
                ...
                return !(r && !function (t, e) {
                    var n, i, r, o = e.toLegacy();
                    for (n = 0; n < t.length; n++) {
                        if (!1 === (r = (i = t[n].eventInstance).def.getOverlap())) return !1;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(3), o = n(0), s = n(34), l = n(209), u = n(17), a = function (e) {
            function t() {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var s = n(3), r = n(35), o = n(18), i = n(210), a = n(6),
            l = {start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], rendering: "inverse-background"}, u = function () {
                ...
                return t.prototype.buildEventInstanceGroup = function (t, e) {
                    ...
                    var e, n = this.rawComplexDef, i = [], r = !1, o = [];
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(3), o = n(20), s = n(6), a = function (n) {
            function t() {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), c = n(3), h = n(4), r = n(20), o = n(6), s = function (t) {
            function d() {
                return null !== t && t.apply(this, arguments) || this
            }
            ...
            return i.__extends(d, t), d.parse = function (t, e) {
                var n;
                return "string" == typeof t.url ? n = t : "string" == typeof t && (n = {url: t}), !!n && o.default.parse.call(this, n, e)
            }, d.prototype.fetch = function (t, e, n) {
                var s = this, i = this.ajaxSettings, a = i.success, l = i.error, u = this.buildRequestParams(t, e, n);
                return this.calendar.pushLoading(), r.default.construct(function (r, o) {
                    c.ajax(c.extend({}, d.AJAX_DEFAULTS, i, {
                        url: s.url, data: u, success: function (t, e, n) {
                            var i;
                            s.calendar.popLoading(), t ? (i = h.applyAll(a, s, [t, e, n]), c.isArray(i) && (t = i), r(s.parseEventDefs(t))) : o()
                        }, error: function (t, e, n) {
                            s.calendar.popLoading(), h.applyAll(l, s, [t, e, n]), o()
                        }
                    }))
                })
            }, d.prototype.buildRequestParams = function (t, e, n) {
                var i, r, o, s, a = this.calendar, l = this.ajaxSettings, u = {};
                ...
                this.ajaxSettings = t
            }, d.AJAX_DEFAULTS = {dataType: "json", cache: !1}, d
        }(o.default);
        (e.default = s).defineStandardProps({url: !0, startParam: !0, endParam: !0, timezoneParam: !0})
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        ...
        var i = n(2), r = function (n) {
            ...
            return i.__extends(t, n), t.prototype.queue = function (t, e, n) {
                ...
                if (t.namespace && "destroy" === t.type) for (e = i.length - 1; 0 <= e; e--) switch (n = i[e], n.type) {
                    case"init":
                        r = !1;
                    case"add":
                    case"remove":
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var o = n(2), a = n(3), s = n(0), l = n(4), u = n(10), d = n(47), i = n(237), c = n(35), r = function (i) {
            function r(t, e) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var s = n(3), i = n(0), a = n(4), r = n(32), l = n(238), u = n(21), d = n(11), c = n(7), h = n(239), p = n(240),
            f = n(241), g = n(207), v = n(31), y = n(10), m = n(5), w = n(12), D = n(17), b = n(242), S = n(212),
            _ = n(38), E = n(49), M = n(13), C = n(37), T = n(6), R = n(51), P = function () {
                function t(t, e) {
                ...
                return t.prototype.constructed = function () {
                    ...
                    var o = this, i = this.el;
                    i.addClass("fc"), i.on("click.fc", "a[data-goto]", function (t) {
                        var e = s(t.currentTarget).data("goto"), n = o.moment(e.date), i = e.type,
                        ...
                        var e = new (R.getThemeSystemClass(t.themeSystem || t.theme))(o.optionsManager),
                            n = e.getClass("widget");
                        ...
                        o.businessHourGenerator = new S.default(t.businessHours, o), o.view && o.view.set("businessHourGenerator", o.businessHourGenerator)
                    }, function () {
                    ...
                    this.header = new h.default(this, this.computeHeaderOptions()), this.footer = new h.default(this, this.computeFooterOptions()), this.toolbarsManager = new l.default([this.header, this.footer])
                    ...
                    this.defaultAllDayEventDuration = i.duration(this.opt("defaultAllDayEventDuration")), this.defaultTimedEventDuration = i.duration(this.opt("defaultTimedEventDuration")), this.optionsManager.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function (t) {
                        var e, n = t.weekNumberCalculation, i = t.firstDay;
                        "iso" === n && (n = "ISO");
                        var r = Object.create(v.getMomentLocaleData(t.locale));
                    ...
                    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                    var n;
                    return "local" === this.opt("timezone") ? (n = y.default.apply(null, t)).hasTime() && n.local() : n = "UTC" === this.opt("timezone") ? y.default.utc.apply(null, t) : y.default.parseZone.apply(null, t), this.localizeMoment(n), n
                    ...
                    return e || (n = y.default.utc(t.unzonedRange.endMs)), t.isAllDay ? (i.stripTime(), n && n.stripTime()) : (i = this.applyTimezone(i), n && (n = this.applyTimezone(n))), new D.default(i, n, this)
                    ...
                    void 0 === e && (e = !1);
                    var n = this.eventManager, i = E.default.parse(t, t.source || n.stickySource);
                    i && n.addEventDef(i, e)
                }, t.prototype.removeEvents = function (t) {
                    var e, n = this.eventManager, i = [], r = {};
                    if (null == t) n.removeAllEventDefs(); else {
                        for (n.getEventInstances().forEach(function (t) {
                            i.push(t.toLegacy())
                        }), i = o(i, t), e = 0; e < i.length; e++) r[this.eventManager.getEventDefByUid(i[e]._id).id] = !0;
                    ...
                    i instanceof M.default && (e = i.buildInstance(), n = C.default.createFromRawProps(e, t, null), this.eventManager.mutateEventsWithId(i.id, n))
        ...
        e.default = P, d.default.mixInto(P), c.default.mixInto(P)
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var h = n(0), c = n(4), p = n(5), i = function () {
            function t(t) {
                this._view = t
            }
            ...
            return t.prototype.opt = function (t) {
                ...
                return i = this.buildValidRange(), i = this.trimHiddenDays(i), n && (t = this.msToUtcMoment(i.constrainDate(t), c)), r = this.buildCurrentRangeInfo(t, e), o = /^(year|month|week|day)$/.test(r.unit), s = this.buildRenderRange(this.trimHiddenDays(r.unzonedRange), r.unit, o), a = (s = this.trimHiddenDays(s)).clone(), this.opt("showNonCurrentDates") || (a = a.intersect(r.unzonedRange)), u = h.duration(this.opt("minTime")), d = h.duration(this.opt("maxTime")), (a = (a = this.adjustActiveRange(a, u, d)).intersect(i)) && (t = this.msToUtcMoment(a.constrainDate(t), c)), l = r.unzonedRange.intersectsWith(i), {
                    validUnzonedRange: i,
                    currentUnzonedRange: r.unzonedRange,
                    currentRangeUnit: r.unit,
                    isRangeAllDay: o,
                    activeUnzonedRange: a,
                    renderUnzonedRange: s,
                    minTime: u,
                    maxTime: d,
                    isValid: l,
                    date: t,
                ...
                var n, i = this._view.viewSpec, r = null, o = null, s = null;
                ...
                return this._view.usesMinMaxTime && (e < 0 && i.time(0).add(e), 864e5 < n && r.time(n - 864e5)), new p.default(i, r)
            }, t.prototype.buildRangeFromDuration = function (t, e, n, i) {
                function r() {
                    a = t.clone().startOf(d), l = a.clone().add(n), u = new p.default(a, l)
                }

                var o, s, a, l, u, d = this.opt("dateAlignment");
                return d || (o = this.opt("dateIncrement"), d = o ? (s = h.duration(o)) < n ? c.computeDurationGreatestUnit(s, o) : i : i), n.as("days") <= 1 && this._view.isHiddenDay(a) && (a = this._view.skipHiddenDays(a, e)).startOf("day"), r(), this.trimHiddenDays(u) || (t = this._view.skipHiddenDays(t, e), r()), u
            }, t.prototype.buildRangeFromDayCount = function (t, e, n) {
                var i, r = this.opt("dateAlignment"), o = 0, s = t.clone();
                ...
                return n ? h.duration(n) : (e = this.opt("dateAlignment")) ? h.duration(1, e) : t || h.duration({days: 1})
            }, t
        }();
        e.default = i
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), f = n(3), g = n(0), v = n(16), y = n(4), o = n(10), r = n(7), m = n(23), s = n(13), w = n(18),
            a = n(6), l = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return i.__extends(t, e), t.prototype.end = function () {
                    ...
                    var n, i;
                    this.opt("droppable") && (n = f((e ? e.item : null) || t.target), i = this.opt("dropAccept"), (f.isFunction(i) ? i.call(n[0], n) : n.is(i)) && (this.isDragging || this.listenToExternalDrag(n, t, e)))
                }, t.prototype.listenToExternalDrag = function (e, t, n) {
                    var i, r, o, s, a, l, u, d = this, c = this.component, h = this.view,
                        p = (r = e, (u = v.dataAttrPrefix) && (u += "-"), (o = r.data(u + "event") || null) && (null == (s = (o = "object" == typeof o ? f.extend({}, o) : {}).start) && (s = o.time), a = o.duration, l = o.stick, delete o.start, delete o.time, delete o.duration, delete o.stick), null == s && (s = r.data(u + "start")), null == s && (s = r.data(u + "time")), null == a && (a = r.data(u + "duration")), null == l && (l = r.data(u + "stick")), {
                            eventProps: o,
                            startTime: s = null != s ? g.duration(s) : null,
                            duration: a = null != a ? g.duration(a) : null,
                            stick: l = Boolean(l)
                        });
                    (this.dragListener = new m.default(c, {
                        interactionStart: function () {
                            d.isDragging = !0
                        }, hitOver: function (t) {
                            var e, n = t.component.getSafeHitFootprint(t);
                            !!n && (!!(i = d.computeExternalDrop(n, p)) && (e = new w.default(i.buildInstances()), p.eventProps ? c.isEventInstanceGroupAllowed(e) : c.isExternalInstanceGroupAllowed(e))) || (i = null, y.disableCursor()), i && c.renderDrag(c.eventRangesToEventFootprints(e.sliceRenderRanges(c.dateProfile.renderUnzonedRange, h.calendar)))
                        }, hitOut: function () {
                            i = null
                        }, hitDone: function () {
                            y.enableCursor(), c.unrenderDrag()
                        }, interactionEnd: function (t) {
                            i && h.reportExternalDrop(i, Boolean(p.eventProps), Boolean(p.stick), e, t, n), d.isDragging = !1, d.dragListener = null
                        }
                    })).startDrag(t)
                }, t.prototype.computeExternalDrop = function (t, e) {
                    var n, i = this.view.calendar, r = o.default.utc(t.unzonedRange.startMs).stripZone();
                    return t.isAllDay && (e.startTime ? r.time(e.startTime) : r.stripTime()), e.duration && (n = r.clone().add(e.duration)), r = i.applyTimezone(r), n && (n = i.applyTimezone(n)), s.default.parse(f.extend({}, e.eventProps, {
                        start: r,
                        end: n
                    }), new a.default(i))
                }, t
            }(n(15).default);
        e.default = l, r.default.mixInto(l), v.dataAttrPrefix = ""
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), g = n(4), a = n(37), l = n(50), v = n(23), i = function (i) {
            function t(t, e) {
            ...
            return r.__extends(t, i), t.prototype.end = function () {
                ...
                var e, l, u = this, d = this.component, c = this.view, h = c.calendar, p = h.eventManager, n = s.el,
                    f = s.footprint.eventDef, i = s.footprint.eventInstance;
                return this.dragListener = new v.default(d, {
                    ...
                    dragStart: function (t) {
                        e = !0, u.eventPointing.handleMouseout(s, t), u.segResizeStart(s, t)
                    },
                    hitOver: function (t, e, n) {
                        var i, r = d.getSafeHitFootprint(n), o = d.getSafeHitFootprint(t);
                        !(!r || !o) && (!!(l = a ? u.computeEventStartResizeMutation(r, o, s.footprint) : u.computeEventEndResizeMutation(r, o, s.footprint)) && (i = p.buildMutatedEventInstanceGroup(f.id, l), d.isEventInstanceGroupAllowed(i))) ? l.isEmpty() && (l = null) : (l = null, g.disableCursor()), l && (c.hideEventsWithId(s.footprint.eventDef.id), c.renderEventResize(d.eventRangesToEventFootprints(i.sliceRenderRanges(d.dateProfile.renderUnzonedRange, h)), s))
                    },
                    hitOut: function () {
                        l = null
                    },
                    hitDone: function () {
                        c.unrenderEventResize(s), c.showEventsWithId(s.footprint.eventDef.id), g.enableCursor()
                    },
                    interactionEnd: function (t) {
                        e && u.segResizeStop(s, t), l && c.reportEventResize(i, l, n, t), u.dragListener = null
                    }
                })
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), v = n(4), o = n(37), u = n(50), s = n(54), y = n(23), m = n(244), i = function (i) {
            function t(t, e) {
                var n = i.call(this, t) || this;
            ...
            return r.__extends(t, i), t.prototype.end = function () {
                ...
                var e, a, l, u = this, d = this.component, c = this.view, h = c.calendar, p = h.eventManager, n = s.el,
                    f = s.footprint.eventDef, i = s.footprint.eventInstance;
                if (this.dragListener) return this.dragListener;
                var g = this.dragListener = new y.default(c, {
                    scroll: this.opt("dragScroll"), subjectEl: n, subjectCenter: !0, interactionStart: function (t) {
                        s.component = d, e = !1, (a = new m.default(s.el, {
                        ...
                        g.isTouch && !c.isEventDefSelected(f) && i && c.selectEventInstance(i), e = !0, u.eventPointing.handleMouseout(s, t), u.segDragStart(s, t), c.hideEventsWithId(s.footprint.eventDef.id)
                    }, hitOver: function (t, e, n) {
                        var i, r, o;
                        s.hit && (n = s.hit), i = n.component.getSafeHitFootprint(n), r = t.component.getSafeHitFootprint(t), !(!i || !r) && (!!(l = u.computeEventDropMutation(i, r, f)) && (o = p.buildMutatedEventInstanceGroup(f.id, l), d.isEventInstanceGroupAllowed(o))) || (l = null, v.disableCursor()), l && c.renderDrag(d.eventRangesToEventFootprints(o.sliceRenderRanges(d.dateProfile.renderUnzonedRange, h)), s, g.isTouch) ? a.hide() : a.show(), e && (l = null)
                    }, hitOut: function () {
                        c.unrenderDrag(s), a.show(), l = null
                    }, hitDone: function () {
                        v.enableCursor()
                    }, interactionEnd: function (t) {
                        delete s.component, a.stop(!l, function () {
                            e && (c.unrenderDrag(s), u.segDragStop(s, t)), c.showEventsWithId(s.footprint.eventDef.id), l && c.reportEventDrop(i, l, n, t)
                        }), u.dragListener = null
                    }
                });
                return g
                ...
                var n, i, r = t.unzonedRange.getStart(), o = e.unzonedRange.getStart(), s = !1, a = !1, l = !1;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), l = n(4), r = n(23), o = n(12), s = n(5), a = function (n) {
            function t(t) {
                var e = n.call(this, t) || this;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i, r, s = n(2), l = n(0), u = n(3), d = n(4), c = n(39), a = n(41), h = n(227), p = n(61),
            f = function (a) {
                function t(t, e) {
                    var n = a.call(this, t, e) || this;
                    return n.usesMinMaxTime = !0, n.timeGrid = n.instantiateTimeGrid(), n.addChild(n.timeGrid), n.opt("allDaySlot") && (n.dayGrid = n.instantiateDayGrid(), n.addChild(n.dayGrid)), n.scroller = new c.default({
                        overflowX: "hidden",
                        overflowY: "auto"
                    }), n
                }

                return s.__extends(t, a), t.prototype.instantiateTimeGrid = function () {
                    var t = new this.timeGridClass(this);
                    return d.copyOwnProps(i, t), t
                }, t.prototype.instantiateDayGrid = function () {
                    var t = new this.dayGridClass(this);
                    return d.copyOwnProps(r, t), t
                }, t.prototype.renderSkeleton = function () {
                    var t, e;
                    ...
                    var i, r, o;
                    if (a.prototype.updateSize.call(this, t, e, n), this.axisWidth = d.matchCellWidths(this.el.find(".fc-axis")), this.timeGrid.colEls) {
                        var s = this.el.find(".fc-row:not(.fc-scroller *)");
                        this.timeGrid.bottomRuleEl.hide(), this.scroller.clear(), d.uncompensateScroll(s), this.dayGrid && (this.dayGrid.removeSegPopover(), (i = this.opt("eventLimit")) && "number" != typeof i && (i = 5), i && this.dayGrid.limitRows(i)), e || (r = this.computeScrollerHeight(t), this.scroller.setHeight(r), ((o = this.scroller.getScrollbarWidths()).left || o.right) && (d.compensateScroll(s, o), r = this.computeScrollerHeight(t), this.scroller.setHeight(r)), this.scroller.lockOverflow(o), this.timeGrid.getTotalSlatHeight() < r && this.timeGrid.bottomRuleEl.show())
                    } else e || (r = this.computeScrollerHeight(t), this.scroller.setHeight(r))
                }, t.prototype.computeScrollerHeight = function (t) {
                    return t - d.subtractInnerElHeight(this.el, this.scroller.el)
                }, t.prototype.computeInitialDateScroll = function () {
                    var t = l.duration(this.opt("scrollTime")), e = this.timeGrid.computeTimeTop(t);
        ...
        (e.default = f).prototype.timeGridClass = h.default, f.prototype.dayGridClass = p.default, i = {
            renderHeadIntroHtml: function () {
                ...
                return this.opt("weekNumbers") ? (t = i.format(this.opt("smallWeekFormat")), '<th class="fc-axis fc-week-number ' + n.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + ">" + e.buildGotoAnchorHtml({
                    ...
                    type: "week",
                    forceOff: 1 < this.colCnt
                }, d.htmlEscape(t)) + "</th>") : '<th class="fc-axis ' + n.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + "></th>"
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), c = n(0), h = n(4), i = n(40), s = n(56), a = n(60), l = n(55), u = n(53), d = n(5),
            p = n(12), f = n(246), g = n(247), v = n(248),
            y = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}], m = function (i) {
                function t(t) {
                ...
                return r.__extends(t, i), t.prototype.componentFootprintToSegs = function (t) {
                    ...
                    var e, n, i;
                    for (e = y.length - 1; 0 <= e; e--) if (n = c.duration(y[e]), i = h.divideDurationByDuration(n, t), h.isInt(i) && 1 < i) return n;
                    return c.duration(t)
                }, t.prototype.renderDates = function (t) {
                    ...
                    if (this.colContainerEls) {
                        var e, n = this.componentFootprintToSegs(new p.default(new d.default(t, t.valueOf() + 1), !1)),
                            i = this.computeDateTop(t, t), r = [];
                    ...
                    var e, n, i = this.slatEls.length, r = (t - this.dateProfile.minTime) / this.slotDuration;
                    ...
                    return n.time(i), e = n.clone().add(this.snapDuration), new p.default(new d.default(n, e), !1)
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), a = n(5), r = function (s) {
            function t() {
                return null !== s && s.apply(this, arguments) || this
            }

            return i.__extends(t, s), t.prototype.buildRenderRange = function (t, e, n) {
                var i = s.prototype.buildRenderRange.call(this, t, e, n), r = this.msToUtcMoment(i.startMs, n),
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), a = n(3), o = n(4), s = n(5), i = n(41), l = n(39), u = n(254), d = n(255), c = function (i) {
            function t(t, e) {
                var n = i.call(this, t, e) || this;
            ...
            return r.__extends(t, i), t.prototype.renderSkeleton = function () {
                ...
                var e, n, i, r = this.groupSegsByDay(t),
                    ...
                    s = o.find("tbody");
                for (e = 0; e < r.length; e++) if (n = r[e]) for (s.append(this.dayHeaderHtml(this.dayDates[e])), this.eventRenderer.sortEventSegs(n), i = 0; i < n.length; i++) s.append(n[i].el);
        ...
        var l = n(3), i = n(16), u = n(4), d = n(220);
        n(10), n(47), n(256), n(257), n(260), n(261), n(262), n(263), l.fullCalendar = i, l.fn.fullCalendar = function (o) {
            var s = Array.prototype.slice.call(arguments, 1), a = this;
            return this.each(function (t, e) {
                var n, i = l(e), r = i.data("fullCalendar");
        ...
        var D = n(3), b = n(4), i = function () {
            ...
            return t.prototype.setToolbarOptions = function (t) {
                ...
                t ? (e ? e.empty() : e = this.el = D("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>"), e.append(this.renderSection("left")).append(this.renderSection("right")).append(this.renderSection("center")).append('<div class="fc-clear"/>')) : this.removeElement()
            }, t.prototype.removeElement = function () {
                this.el && (this.el.remove(), this.el = null)
            }, t.prototype.renderSection = function (t) {
                var p = this, f = this.calendar, g = f.theme, e = f.optionsManager, v = f.viewSpecManager,
                    i = D('<div class="fc-' + t + '"/>'), n = this.toolbarOptions.layout[t],
                    y = e.get("customButtons") || {}, m = e.overrides.buttonText || {}, w = e.get("buttonText") || {};
                return n && D.each(n.split(" "), function (t, e) {
                    var n, c = D(), h = !0;
                    D.each(e.split(","), function (t, e) {
                        var n, i, r, o, s, a, l, u, d;
                        "title" === e ? (c = c.add(D("<h2>&nbsp;</h2>")), h = !1) : ((n = y[e]) ? (r = function (t) {
                            n.click && n.click.call(u[0], t)
                        }, (o = g.getCustomButtonIconClass(n)) || (o = g.getIconClass(e)) || (s = n.text)) : (i = v.getViewSpec(e)) ? (p.viewsWithButtons.push(e), r = function () {
                            f.changeView(e)
                        }, (s = i.buttonTextOverride) || (o = g.getIconClass(e)) || (s = i.buttonTextDefault)) : f[e] && (r = function () {
                            f[e]()
                        }, (s = m[e]) || (o = g.getIconClass(e)) || (s = w[e])), r && (l = ["fc-" + e + "-button", g.getClass("button"), g.getClass("stateDefault")], s ? (a = b.htmlEscape(s), d = "") : o && (a = "<span class='" + o + "'></span>", d = ' aria-label="' + e + '"'), u = D('<button type="button" class="' + l.join(" ") + '"' + d + ">" + a + "</button>").click(function (t) {
                    ...
                    }), h && c.first().addClass(g.getClass("cornerLeft")).end().last().addClass(g.getClass("cornerRight")).end(), 1 < c.length ? (n = D("<div/>"), h && n.addClass(g.getClass("buttonGroup")), n.append(c), i.append(n)) : i.append(c)
                }), i
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), s = n(4), a = n(32), l = n(31), i = function (i) {
            function t(t, e) {
                var n = i.call(this) || this;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var c = n(0), r = n(3), h = n(22), p = n(4), f = n(32), i = n(31), o = function () {
            function t(t, e) {
            ...
            return t.prototype.clearCache = function () {
                ...
                var e, n, i;
                if (-1 !== r.inArray(t, p.unitsDesc)) for (e = this._calendar.header.getViewsWithButtons(), r.each(h.viewHash, function (t) {
                    e.push(t)
                }), n = 0; n < e.length; n++) if ((i = this.getViewSpec(e[n])) && i.singleUnit === t) return i
            }, t.prototype.buildViewSpec = function (t) {
                for (var e, n, i, r, o, s = this.optionsManager.overrides.views || {}, a = [], l = [], u = [], d = t; d;) e = h.viewHash[d], n = s[d], d = null, "function" == typeof e && (e = {class: e}), e && (a.unshift(e), l.unshift(e.defaults || {}), i = i || e.duration, d = d || e.type), n && (u.unshift(n), i = i || n.duration, d = d || n.type);
                return (e = p.mergeProps(a)).type = t, !!e.class && ((i = i || this.optionsManager.dynamicOverrides.duration || this.optionsManager.overrides.duration) && ((r = c.duration(i)).valueOf() && (o = p.computeDurationGreatestUnit(r, i), e.duration = r, e.durationUnit = o, 1 === r.as(o) && (e.singleUnit = o, u.unshift(s[o] || {})))), e.defaults = f.mergeOptions(l), e.overrides = f.mergeOptions(u), this.buildViewSpecOptions(e), this.buildViewSpecButtonText(e, t), e)
                ...
                var e = this.optionsManager;
                n.buttonTextOverride = t(e.dynamicOverrides) || t(e.overrides) || n.overrides.buttonText, n.buttonTextDefault = t(e.localeDefaults) || t(e.dirDefaults) || n.defaults.buttonText || t(f.globalDefaults) || (n.duration ? this._calendar.humanizeDuration(n.duration) : null) || i
            }, t
        }();
        e.default = o
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(3), i = n(4), o = n(243), s = n(52), a = n(6), l = n(38), u = n(13), d = n(18), c = n(11), h = n(7),
            p = function () {
                function t(t) {
        ...
        var i = n(3), r = n(4), o = n(20), s = n(11), a = n(5), l = n(18), u = function () {
            ...
            return t.prototype.isWithinRange = function (t, e) {
                ...
                var t, n = this.eventInstanceGroupsById, i = n[e.id];
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var o = n(3), i = n(4), r = n(7), s = function () {
            function t(t, e) {
            ...
            return t.prototype.start = function (t) {
                ...
                var n = this, i = this.options.revertDuration, r = function () {
        ...
        var i = n(2), s = n(23), r = function (n) {
            ...
            return i.__extends(t, n), t.prototype.end = function () {
                ...
                var i, r = this, o = this.component, t = new s.default(o, {
                    scroll: this.opt("dragScroll"), interactionStart: function () {
                        i = t.origHit
                    }, hitOver: function (t, e, n) {
                        e || (i = null)
        ...
        var r = n(2), y = n(4), i = function (i) {
            ...
            return r.__extends(t, i), t.prototype.renderFgSegs = function (t) {
                ...
                var n, i, r, o = this.view, s = o.calendar, a = t.footprint.componentFootprint, l = a.isAllDay,
                    u = t.footprint.eventDef, d = o.isEventDefDraggable(u),
                    c = !e && t.isStart && o.isEventDefResizableFromStart(u),
                    h = !e && t.isEnd && o.isEventDefResizableFromEnd(u), p = this.getSegClasses(t, d, c || h),
                    f = y.cssToStr(this.getSkinCss(u));
                if (p.unshift("fc-time-grid-event", "fc-v-event"), o.isMultiDayRange(a.unzonedRange)) {
                    if (t.isStart || t.isEnd) {
                        var g = s.msToMoment(t.startMs), v = s.msToMoment(t.endMs);
                ...
                return '<a class="' + p.join(" ") + '"' + (u.url ? ' href="' + y.htmlEscape(u.url) + '"' : "") + (f ? ' style="' + f + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + y.htmlEscape(r) + '" data-full="' + y.htmlEscape(i) + '"><span>' + y.htmlEscape(n) + "</span></div>" : "") + (u.title ? '<div class="fc-title">' + y.htmlEscape(u.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (h ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                ...
                if (this.sortEventSegs(t), function (t) {
                    var e, n, i, r, o;
                    for (e = 0; e < t.length; e++) for (n = t[e], i = 0; i < n.length; i++) for ((r = n[i]).forwardSegs = [], o = e + 1; o < t.length; o++) s(r, t[o], r.forwardSegs)
                }(e = function (t) {
                    var e, n, i, r = [];
                ...
                return i && (o = Math.min(1, r + 2 * (o - r))), n = a ? (e = 1 - o, r) : (e = r, 1 - o), s.zIndex = t.level + 1, s.left = 100 * e + "%", s.right = 100 * n + "%", i && t.forwardPressure && (s[a ? "marginLeft" : "marginRight"] = 20), s
            }, t
        }(n(42).default);
        e.default = i
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), s = n(3), r = function (t) {
            function e() {
                return null !== t && t.apply(this, arguments) || this
            }
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var c = n(3), h = n(4), i = n(7), r = function () {
            function t(t) {
            ...
            return t.prototype.show = function () {
                ...
                var t, e, n, i, r, o = this.options, s = this.el.offsetParent().offset(), a = this.el.outerWidth(),
                    l = this.el.outerHeight(), u = c(window), d = h.getScrollParent(this.el);
        ...
        function o(t, e) {
            var n, i;
            for (n = 0; n < e.length; n++) if ((i = e[n]).leftCol <= t.rightCol && i.rightCol >= t.leftCol) return !0;
            return !1
        }
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), y = n(3), p = n(4), i = function (i) {
            function t(t, e) {
                var n = i.call(this, t, e) || this;
            ...
            return r.__extends(t, i), t.prototype.renderBgRanges = function (t) {
                ...
                function n(t) {
                    for (; o < t;) (u = (v[i - 1] || [])[o]) ? u.attr("rowspan", parseInt(u.attr("rowspan") || 1, 10) + 1) : (u = y("<td/>"), s.append(u)), g[i][o] = u, v[i][o] = u, o++
                }

                var i, r, o, s, a, l, u, d = this.dayGrid.colCnt, c = this.buildSegLevels(e), h = Math.max(1, c.length),
                    p = y("<tbody/>"), f = [], g = [], v = [];
                for (i = 0; i < h; i++) {
                    if (r = c[i], o = 0, s = y("<tr/>"), f.push([]), g.push([]), v.push([]), r) for (a = 0; a < r.length; a++) {
                        for (n((l = r[a]).leftCol), u = y('<td class="fc-event-container"/>').append(l.el), l.leftCol !== l.rightCol ? u.attr("colspan", l.rightCol - l.leftCol + 1) : v[i][o] = u; o <= l.rightCol;) g[i][o] = u, f[i][o] = l, o++;
                        s.append(u)
                    }
                    n(d), this.dayGrid.bookendCells(s), p.append(s)
                }
                ...
                var n, i, r = this.view, o = t.footprint.eventDef, s = t.footprint.componentFootprint.isAllDay,
                    a = r.isEventDefDraggable(o), l = !e && s && t.isStart && r.isEventDefResizableFromStart(o),
                    u = !e && s && t.isEnd && r.isEventDefResizableFromEnd(o), d = this.getSegClasses(t, a, l || u),
                    c = p.cssToStr(this.getSkinCss(o)), h = "";
                return d.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + p.htmlEscape(n) + "</span>"), i = '<span class="fc-title">' + (p.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a class="' + d.join(" ") + '"' + (o.url ? ' href="' + p.htmlEscape(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? i + " " + h : h + " " + i) + "</div>" + (l ? '<div class="fc-resizer fc-start-resizer" />' : "") + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
            }, t
        }(n(42).default);
        e.default = i
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), u = n(3), r = function (t) {
            function e() {
                return null !== t && t.apply(this, arguments) || this
            }
            ...
            return i.__extends(e, t), e.prototype.renderSegs = function (t, s) {
                ...
                return a = this.eventRenderer.renderSegRows(t), this.component.rowEls.each(function (t, e) {
                    var n, i, r = u(e), o = u('<div class="fc-helper-skeleton"><table/></div>');
                    i = s && s.row === t ? s.el.position().top : ((n = r.find(".fc-content-skeleton tbody")).length || (n = r.find(".fc-content-skeleton table")), n.position().top), o.css("top", i).find("table").append(a[t].tbodyEl), r.append(o), l.push(o[0])
                }), u(l)
            }, e
        }(n(58).default);
        e.default = r
        ...
        var i = n(2), l = n(3), r = function (e) {
            ...
            return i.__extends(t, e), t.prototype.attachSegEls = function (t, e) {
                ...
                var n, i, r, o = this.component.colCnt, s = e.leftCol, a = e.rightCol + 1;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), r = n(228), l = n(5), o = function (a) {
            function t() {
                return null !== a && a.apply(this, arguments) || this
            }

            return i.__extends(t, a), t.prototype.buildRenderRange = function (t, e, n) {
                var i, r = a.prototype.buildRenderRange.call(this, t, e, n), o = this.msToUtcMoment(r.startMs, n),
        ...
        var i = n(2), c = n(4), r = function (t) {
            ...
            return i.__extends(e, t), e.prototype.renderFgSegs = function (t) {
                ...
                var e, n = this.view, i = n.calendar, r = i.theme, o = t.footprint, s = o.eventDef,
                    a = o.componentFootprint, l = s.url, u = ["fc-list-item"].concat(this.getClasses(s)),
                    d = this.getBgColor(s);

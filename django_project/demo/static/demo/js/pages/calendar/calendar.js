$(function () {
    ...
    console.log(event_data, hospital_setting);
    ...
    calendar.fullCalendar({
        ...
        nowIndicator: true,
        events: event_data,
        minTime: hospital_setting.startTime,
        maxTime: hospital_setting.endTime,
        ...
        eventClick: function (calEvent, jsEvent, view) {
            ...
            eventModal.find('span[id="doctor"]').html(calEvent.doctor);
